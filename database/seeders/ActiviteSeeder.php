...
class ActiviteSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Activite::factory()->create([
            ...
            "image" => public_path("images/dedicaces.png"),
            "user_id" => 1
        ]);
        ...
        Activite::factory()->create([
            ...
            "image" => public_path("images/projection.png"),
            "user_id" => 2
        ]);
        ...
        Activite::factory()->create([
            ...
            "image" => public_path("images/cosplay-concours.png"),
            "user_id" => 3
        ]);
        ...
        Activite::factory()->create([
            ...
            "image" => public_path("images/kiosque-produits.png"),
            "user_id" => 4
        ]);
        ...
        Activite::factory()->create([
            ...
            "image" => public_path("images/performance-direct.png"),
            "user_id" => 5
        ]);
    }
}
